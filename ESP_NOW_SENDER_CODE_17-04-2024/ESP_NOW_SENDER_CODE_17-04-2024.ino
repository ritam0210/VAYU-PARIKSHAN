...
LiquidCrystal_I2C lcd(0x3F, 16, 2);  // 0x3F for a 16x2 display //0x27 in node3
//================================================================================================
...
//=============================DEFINING DHT11 functions and variables=============================
...
#define BOARD_ID 1    //CHANGE BEFORE UPLOADING
...
//constexpr char WIFI_SSID[] = "Accio_WiFi";
...
//   if ((currentMillis1 - previousMillis1 >= 0) && (currentMillis1 - previousMillis1 < 3000))
   {
     lcd.clear();
     lcd.setCursor(0,0);
     lcd.print("MQ4 = ");
...
//   else if ((currentMillis1 - previousMillis1 >= 3000) && (currentMillis1 - previousMillis1 < 6000))
   {
     lcd.clear();
     lcd.setCursor(0,0);
     lcd.print("MQ9 = ");
...
//   else if ((currentMillis1 - previousMillis1 >= 6000) && (currentMillis1 - previousMillis1 < 9000))
   {
     lcd.clear();
     lcd.setCursor(0,0);
     lcd.print("T=");
